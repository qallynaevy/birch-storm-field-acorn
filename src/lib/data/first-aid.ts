export type AidGuide = {
  slug: string;
  title: string;
  summary: string;
  urgency: "segera" | "cepat" | "pantau";
  call112: boolean;
  icon: "heart" | "wind" | "droplet" | "flame" | "frown" | "bone" | "bug" | "waves" | "zap" | "sun";
  steps: { title: string; body: string }[];
  avoid: string[];
  after: string[];
};

export const firstAidGuides: AidGuide[] = [
  {
    slug: "henti-jantung",
    ...
    after: [
      "Serahkan ke petugas medis dan ceritakan apa yang kamu lakukan.",
      "RJP awam adalah tekan dada. Napas buatan hanya jika kamu sudah dilatih.",
    ],
  },
  {
    slug: "tersedak",
    ...
    avoid: [
      "Jangan memasukkan jari ke mulut jika benda tidak terlihat — bisa mendorongnya lebih dalam.",
      "Jangan menepuk punggung bayi seperti orang dewasa. Untuk bayi, posisi telungkup di lengan, kepala lebih rendah, tepukan di punggung.",
    ],
    after: [
      "Meski benda sudah keluar, periksa ke fasilitas kesehatan jika batuk terus, nyeri, atau napas masih aneh.",
    ],
  },
  {
    slug: "pendarahan",
    ...
    after: [
      "Cuci tangan setelah membantu.",
      "Luka dalam, gigitan, atau kotor perlu dibersihkan di faskes dan mungkin suntikan tetanus.",
    ],
  },
  {
    slug: "luka-bakar",
    ...
    after: [
      "Minum air jika sadar, untuk mengganti cairan.",
      "Bakar akibat listrik atau kimia selalu perlu diperiksa tenaga kesehatan.",
    ],
  },
  {
    slug: "pingsan",
    ...
    after: [
      "Telepon 112 jika pingsan saat olahraga, nyeri dada, kejang, diabetes, atau pingsan berulang.",
      "Istirahat dan makan/minum jika pingsan karena lapar atau panas.",
    ],
  },
  {
    slug: "patah-tulang",
    ...
    after: [
      "RICE untuk keseleo ringan: Rest, Ice, Compression, Elevation.",
      "Foto rontgen hanya di faskes — jangan menunda jika bengkak cepat atau tidak bisa menahan beban.",
    ],
  },
  {
    slug: "gigitan-ular",
    ...
    after: [
      "Bawa ke RS yang punya serum, bukan hanya ke klinik kecil jika memungkinkan.",
      "Semua gigitan ular perlu dinilai — beberapa ular berbisa gigitannya terasa ringan di awal.",
    ],
  },
  {
    slug: "tenggelam",
    ...
    avoid: [
      "Jangan memijat perut untuk 'mengeluarkan air'.",
      "Jangan menunda RJP hanya untuk mengeringkan orang.",
    ],
    after: [
      "Semua korban tenggelam harus diperiksa tenaga kesehatan, meski sudah batuk dan bicara. Paru bisa membengkak belakangan.",
    ],
  },
  {
    slug: "kejang",
    ...
    after: [
      "Biarkan istirahat. Banyak orang linglung atau mengantuk sesudahnya.",
      "Jika sudah punya obat kejang dari dokter, ikuti rencana yang sudah diajarkan keluarga.",
    ],
  },
  {
    slug: "sengatan-panas",
    ...
    avoid: [
      "Jangan beri obat demam sebagai pengganti pendinginan.",
      "Jangan biarkan olahraga berlanjut 'supaya tahan panas'.",
    ],
    after: [
      "Istirahat di ruangan sejuk 24 jam.",
      "Bayi, lansia, dan orang dengan penyakit kronis lebih rentan — jangan ditunda.",
    ],
  },
];

export function getFirstAid(slug: string) {
