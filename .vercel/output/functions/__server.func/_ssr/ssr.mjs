...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-lzUJ53WM.mjs");
...
var manifest = { "8ee6f26ab16c4d1fafd9941a7a905d566d65fef23b15832831e585ca82407ceb": {
	functionName: "getLatestQuake_createServerFn_handler",
	importer: () => import("./bmkg-efuDFuus.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BNZR9LX-.mjs").then((n) => n.t),
